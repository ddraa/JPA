...
import book.shop.domain.exception.NotEnoughStockException;
...
public class OrderServiceTest {
    ...
    public void 상품주문_재고수량초과() throws Exception {
        ...
        //then
        fail("재고 수량 부족 예외가 발생해야 한다."); // 이 라인까지 실행되면 안 됨
    }
    ...
    public void 주문취소() throws Exception {
        ...
        assertEquals("주문이 취소된 상품은 재고가 원복돼야 한다.", 10, book.getStockQuantity());
    }
